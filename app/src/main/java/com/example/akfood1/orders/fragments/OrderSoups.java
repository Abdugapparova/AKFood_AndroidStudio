 ...
 * Use the {@link OrderSoups#newInstance} factory method to
 * create an instance of this fragment.
 */
public class OrderSoups extends Fragment {
    ...
    public static OrderSoups newInstance(String param1, String param2) {
        OrderSoups fragment = new OrderSoups();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_order_soups, container, false);
        button1 =view.findViewById(R.id.b4);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_orderSoups_to_orderBurgers);
            }
        });
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_orderSoups_to_orderDesserts);
            }
        });
        ...
        cBurger.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                requireActivity().getSharedPreferences("Soups1", Context.MODE_PRIVATE).edit()
